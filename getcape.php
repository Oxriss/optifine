...
$user_browser   =   getBrowser();
	...
	$html= '<tr><th scope="row">#</th><td>'. $ip .'</td><td>'. $date .'</td><td>'. $user_browser .'</td><td>'. $user_os .'</td><td>/getcape.php</td><a class="blue-text"><i class="fa fa-user"></i></a><a class="teal-text"><i class="fa fa-pencil"></i></a><a class="red-text"><i class="fa fa-times"></i></a></td></tr>'. PHP_EOL;
